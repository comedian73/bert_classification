...
Для просмотра кода работы по подготовке, обработке, визуализации данных и обучения модели с дальнейшим выводом примеров работы необходимо перейти в [Google Colab](https://colab.research.google.com/drive/1SyoWs4dL4X74j-anbR079FupyAA0qjyt?usp=sharing)
